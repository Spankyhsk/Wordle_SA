  ...
  "Gamemech" when{
    ...
    "GameMech" should{
      ...
      "controllLength checked that n have the same length as Wordlength" in{
        ...
        check1.getOrElse(false) should be(true)
        check2.getOrElse(true) should be(false)
      }
      ...
      "setWin set true by key" in{
        ...
        gamemech.getWinOption(1).getOrElse(false) should be(true)
      }
      ...
      "getWin give value from key"in{
        ...
        gamemech.getWinOption(1).getOrElse(true) should be(false)
      }
